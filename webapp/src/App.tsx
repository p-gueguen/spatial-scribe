...
const STEPS: Step[] = [
  ...
  { key: "qc", n: "03", label: "QC", title: "Signal you can trust", sub: "Section QC and the six-layer funnel - box-select a region to QC it on the map.", hint: "Metrics, the six-layer funnel, and box-select region QC.", run: "qc", color: "total_counts" },
